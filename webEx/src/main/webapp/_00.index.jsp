...
<body>
	  ...
	  <h1>N A V E R</h1>
	   <form method = "post" action="_04.main.jsp">
		   ...
		   <input class="req" name = "password" type="text" placeholder="password" title="비밀번호를 입력하세요" required >
            ...
            <input type="button" onclick="location.href='form_join.jsp'" value="회원가입">
            <!-- <input type="button"  onclick="check(form)" value="로그인" > -->
            <input type="button"  onclick="location.href='_04.main.jsp'" value="로그인" >
        </div>
